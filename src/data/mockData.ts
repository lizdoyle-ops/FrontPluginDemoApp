...
export const MOCK_CONTACTS: Record<string, ContactData> = {
  "leyton@finalproduction.club": {
    ...
    quotes: [
      {
        id: "q1",
        referenceNumber: "#RE-1604-08501",
        productName: "Alpine ski week — Chamonix",
        supplier: "Final Production Travel",
        requestedDatesPeriod: "12–19 Jan 2027",
        startingFromPerPerson: 899,
        numberOfParticipants: 4,
        rooms: "2× twin",
        lastName: "Chen",
        firstName: "Leyton",
        address: "42 Elm Street, Manchester M4 2BX",
        phone: "+44 7700 900123",
        email: "leyton@finalproduction.club",
        messageNotes: "Late arrival on day 1; vegetarian meals.",
        participants: [
          { firstName: "Leyton", lastName: "Chen", category: "adult" },
          { firstName: "River", lastName: "Chen", category: "child" },
          { firstName: "Sky", lastName: "Chen", category: "baby" },
        ],
